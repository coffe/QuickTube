...
Vad vill du göra?"
            ...
            if [ -z "$MEDIA_INFO" ]; then
                ...
                # Vi fortsätter inte loopen här för att låta användaren byta inställningar i nästa steg
            else 
                local ITEM_TITLE
                IS_PLAYLIST=false
...
$FORMATTED_TITLE?"
                    ...
                    case "$ACTION" in
                        ...
                        "Ladda ner video")
                            ...
                            # macOS sort (BSD) kanske behöver anpassning, men -k2 -r brukar funka ok.
